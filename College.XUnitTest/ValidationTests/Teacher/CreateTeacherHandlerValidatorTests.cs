...
public class CreateTeacherHandlerValidatorTests
{
    ...
    private readonly CreateTeacherCommandValidator _validator;

    public CreateTeacherHandlerValidatorTests()
    {
        _validator = new CreateTeacherCommandValidator();
    }
    ...
    public void ShouldHaveError_WhenNameLengthIsLessThanAllowed(int number)
    {
        ...
        var command = new CreateTeacherCommand(
            Request: new CreateTeacherRequestDto(
